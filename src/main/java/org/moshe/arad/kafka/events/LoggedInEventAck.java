...
@Component
@Scope("prototype")
public class LoggedInEventAck extends BackgammonEvent {

	private BackgammonUser backgammonUser;

	public LoggedInEventAck() {
		
	}
	
	public LoggedInEventAck(BackgammonUser backgammonUser) {
		super();
		this.backgammonUser = backgammonUser;
	}

	public LoggedInEventAck(UUID uuid, int serviceId, int eventId, Date arrived, String clazz,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LoggedInEventAck other = (LoggedInEventAck) obj;
