...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterOpenByLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterOpenByLeftEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterOpenByLeftEventConsumer() {
	}
