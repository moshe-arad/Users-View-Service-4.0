...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutSecondLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutSecondLeftEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutSecondLeftEventConsumer() {
	}
