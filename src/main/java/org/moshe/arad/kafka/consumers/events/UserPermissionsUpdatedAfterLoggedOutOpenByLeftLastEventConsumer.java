...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutOpenByLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutOpenByLeftLastEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutOpenByLeftLastEventConsumer() {
	}
