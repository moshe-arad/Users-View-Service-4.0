...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterOpenByLeftBeforeGameStartedEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterOpenByLeftBeforeGameStartedEventConsumer() {
	}
