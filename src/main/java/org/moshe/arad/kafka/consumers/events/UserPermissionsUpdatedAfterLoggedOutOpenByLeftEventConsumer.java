...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutOpenByLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutOpenByLeftEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutOpenByLeftEventConsumer() {
	}
