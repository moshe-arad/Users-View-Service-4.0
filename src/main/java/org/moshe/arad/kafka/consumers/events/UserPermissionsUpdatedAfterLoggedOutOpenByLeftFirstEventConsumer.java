...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutOpenByLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutOpenByLeftFirstEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutOpenByLeftFirstEventConsumer() {
	}
