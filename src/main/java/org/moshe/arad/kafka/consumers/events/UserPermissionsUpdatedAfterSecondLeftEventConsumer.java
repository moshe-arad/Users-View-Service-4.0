...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterSecondLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterSecondLeftEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterSecondLeftEventConsumer() {
	}
