...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutSecondLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutSecondLeftLastEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutSecondLeftLastEventConsumer() {
	}
