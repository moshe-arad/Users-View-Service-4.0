...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterSecondLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterSecondLeftFirstEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterSecondLeftFirstEventConsumer() {
	}
