...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterOpenByLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterOpenByLeftLastEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterOpenByLeftLastEventConsumer() {
	}
