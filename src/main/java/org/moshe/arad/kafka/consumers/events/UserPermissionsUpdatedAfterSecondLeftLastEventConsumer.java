...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterSecondLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterSecondLeftLastEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterSecondLeftLastEventConsumer() {
	}
