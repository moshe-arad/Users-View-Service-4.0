...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutOpenByLeftBeforeGameStartedEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutOpenByLeftBeforeGameStartedEventConsumer() {
	}
