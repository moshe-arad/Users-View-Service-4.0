...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterAddWatcherEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterAddWatcherEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterAddWatcherEventConsumer() {
	}
