...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterAddSecondPlayerEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterAddSecondPlayerEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterAddSecondPlayerEventConsumer() {
	}
