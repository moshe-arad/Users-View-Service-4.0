...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLeftLobbyEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLeftLobbyEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLeftLobbyEventConsumer() {
	}
