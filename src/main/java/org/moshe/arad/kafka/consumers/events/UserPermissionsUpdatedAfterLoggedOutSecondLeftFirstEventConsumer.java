...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterLoggedOutSecondLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterLoggedOutSecondLeftFirstEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterLoggedOutSecondLeftFirstEventConsumer() {
	}
