...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAfterOpenByLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private UsersView usersView;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAfterOpenByLeftFirstEventConsumer.class);
	...
	public UserPermissionsUpdatedAfterOpenByLeftFirstEventConsumer() {
	}
